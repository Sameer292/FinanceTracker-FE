				...
				<View className="gap-12 px-4 w-full justify-center items-center">
					...
					<View className="w-full gap-5">
						...
						<View className="gap-2">
							...
							<View
								className={`flex-row items-center ${methods.formState.errors.password ? "border-[#EF476F]" : "border-[#D9E3E8]"} border rounded-lg pr-2`}
							>
								<Controller
									control={methods.control}
									name="password"
						...
						<View className="gap-2">
							...
							<View
								className={`flex-row items-center ${methods.formState.errors.confirmPassword ? "border-[#EF476F]" : "border-[#D9E3E8]"} border rounded-lg pr-2`}
							>
								<Controller
									control={methods.control}
						...
						<View className="flex flex-row gap-1 items-center justify-center">
							...
							<Link href={"/login"}>
								<Text className="text-[#06D6A0] text-md">Login</Text>
							</Link>
						</View>
					</View>
				</View>
