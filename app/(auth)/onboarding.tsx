        ...
        <BottomSheet.Portal>
          ...
          >
            ...
            >
              ...
              <TouchableHighlight underlayColor='#04bf8f' onPress={handleStartedPress} className='h-12 justify-center items-center bg-[#06D6A0] text-white font-nunito-bold rounded-lg'>
