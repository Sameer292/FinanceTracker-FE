...
import { CategoryForm, categorySchema } from 'app/lib/schemas/validationSchemas'
            ...
            <View className="flex-1 justify-between">
                                                ...
                                                <Pressable onPress={() => field.onChange(item)}>
                                                    <View
                                                        ...
                                                        style={{
                                                            ...
                                                            borderColor: isSelected ? '#D9E3E8' : 'transparent',
                                                        }}
                                                    >
                                                        {isSelected && (
                ...
                <View className='gap-2'>
                    ...
                    <Pressable
                        ...
                        className={`h-14 rounded-lg items-center justify-center ${isPending ? 'bg-[#9FE8D6]' : 'bg-[#07D19D]'
                            }`}
                    >
                        <Text
