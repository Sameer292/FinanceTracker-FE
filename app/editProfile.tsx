...
export default function EditProfile() {
    ...
    const editProfileSchema = z.object({
        name: z.string({ error: 'Please enter your name' }).min(3, { error: 'Name must be at least 3 characters long' }),
    ...
    return (
        <View className="flex-1 pt-5 px-4 bg-white">
            ...
            <View className="flex-1 items-center gap-8">
                <View style={{ borderRadius: '100%' }} className='relative rounded-full border-2 border-[#D9E3E8] items-center justify-center size-32' >
                    <Image
