...
export const TransactionTypeSelect = ({
	setectedTransactionType,
	setTransactionType,
	transactionType,
}: {
	setTransactionType: (
		transactionType: TransactionTypeSelect | undefined,
	) => void;
	transactionType: TransactionTypeSelect | undefined;
	setectedTransactionType?: TransactionTypeSelect;
}) => {
	...
	return (
		...
		>
			...
			<Select.Portal className="w-full">
				...
				/>
				<Select.Content className="bg-white px-3 shadow-[1px_1px_25px_5px_rgba(0,0,0,0.29)] border-0 w-1/2 gap-2 py-2.5 rounded-3xl">
										...
										<View
											style={{
												backgroundColor: isSelected
													? transactionType.bgColor
													: "",
											}}
											className={`pr-4 pl-2.5 flex-1 gap-3 flex-row items-center w-full rounded-2xl h-16`}
										>
											<View
												style={{
													backgroundColor: `${transactionType.textColor}40`,
													borderRadius: "100%",
												}}
											...
											<Select.ItemLabel
												style={{
													color: isSelected ? transactionType.textColor : "",
												}}
												className={`text-md font-bold`}
											/>
											<Select.ItemIndicator
												iconProps={{ color: transactionType.textColor }}
											/>
										</View>
									);
								}}
	...
	return (
		...
		>
			<View className="flex-row items-center gap-2">
				<View
					style={{ backgroundColor: `${text}40`, borderRadius: "100%" }}
